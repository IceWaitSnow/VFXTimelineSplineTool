...
namespace VFXTimelineSplineTool
{
    ...
    public class VFXSplineAnimator : MonoBehaviour
    {
        ...
        [Tooltip("烘焙动画时长，单位秒。第一版会把 Progress 0→1 按这个时长采样。")]
        ...
        [Tooltip("烘焙 Progress 来源。Linear=0到1匀速；Bake Progress Curve=使用下方曲线；Current Animator Progress=用当前 Progress 烘焙静态姿态；Existing AnimationClip Progress Curve=读取已有 AnimationClip 里的 VFXSplineAnimator.progress 曲线。")]
